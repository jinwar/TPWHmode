...
parameters.min_width = 0.03;  % to build up gaussian filters
parameters.max_width = 0.08;  
parameters.wintaperlength = 30;   % taper to build up the isolation filter
parameters.prefilter = [10,500];
parameters.xcor_win_halflength = 300;  % window for the cross-correlation
